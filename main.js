...
var typed = new Typed(".para", {
    strings: ["Hello! I’m Patakokila Praveen Kumar, a 19-year-old aspiring Machine Learning Engineer from Andhra Pradesh. I completed my schooling at Smt. Annapurna Vidya Niketan, Velivennu, with a stellar 97% aggregate, and my intermediate education at Sasi Junior College, Velivennu, achieving a 94% score. Currently, I’m pursuing my Bachelor’s in Computer Science and Engineering at Lovely Professional University, Punjab, with a specialization in Machine Learning. My journey so far has been fueled by hands-on experience with multiple machine learning projects, where I’ve developed a deep interest in data-driven solutions and artificial intelligence. I’ve also earned certifications from Coursera in Generative AI and Data Analysis & Algorithms, which have further enhanced my skill set.My ultimate goal is to become a Machine Learning Engineer, where I can continue to learn, sharpen my skills, and contribute to impactful projects."],
    typeSpeed: 10,
    loop: false,
    showCursor: false,
});
